...
export type UrlWhereInput = {
    ...
    count?: Prisma.IntFilter<"Url"> | number;
};
...
export type UrlScalarWhereWithAggregatesInput = {
    ...
    count?: Prisma.IntWithAggregatesFilter<"Url"> | number;
};
...
export type UrlOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "shortCode" | "url" | "count", ExtArgs["result"]["url"]>;
...
export interface UrlFieldRefs {
    ...
    readonly count: Prisma.FieldRef<"Url", 'Int'>;
}
/**
 * Url findUnique
 */
